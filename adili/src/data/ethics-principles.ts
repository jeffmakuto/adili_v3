export const carouselItems = [
    {
      ...
      subLink: { href: '/principles/conflict-of-interest', label: 'Learn More' },
    },
    {
      ...
      subLink: { href: '/principles/gifts-and-entertainment', label: 'Learn More' },
    },
    {
      ...
      subLink: { href: '/principles/ethical-marketing', label: 'Learn More' },
    },
    {
      title: 'Safeguarding',
      content: 'Kenya Airways is committed to promoting and protecting human rights, with zero tolerance for human trafficking, harassment, bullying, and discrimination. We maintain a safe, inclusive, and respectful workplace, with strict principles against sexual harassment.',
      subLink: { href: '/principles/safeguarding', label: 'Learn More' },
    },
    {
      ...
      subLink: { href: '/principles/competition-law', label: 'Learn More' },
    },
    {
      ...
      subLink: { href: '/principles/anti-bribery', label: 'Learn More' },
    },
    {
      ...
      subLink: { href: '/principles/act-right-speak-up', label: 'Learn More' },
    },
    {
      ...
      subLink: { href: '/principles/preventing-criminal-financing', label: 'Learn More' },
    },
    {
      ...
      subLink: { href: '/principles/external-activities', label: 'Learn More' },
    },
    {
      title: 'Company Assets',
      content: 'Protect and use the Company\'s assets as intended, and safeguard nonpublic information. Ensure accuracy in all information, including contracts, pricing, and employee data. Follow KQ\'s information security and data protection principles for proper handling.',
      subLink: { href: '/principles/company-assets', label: 'Learn More' },
    },
  ];
